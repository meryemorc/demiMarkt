...
urlpatterns = [
    ...
    path('add/<int:product_id>/', views.add_to_cart, name='add_to_cart'),  # Ürün Ekle
    path('remove/<int:product_id>/', views.remove_from_cart, name='remove_from_cart'),  # Ürün Çıkar
